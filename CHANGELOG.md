...
- Added an optional title slot to the `qr-links` layout.
- Added a shared opacity hover and focus treatment for interactive footer elements.
- Centered visible content vertically in both split-image layouts.
